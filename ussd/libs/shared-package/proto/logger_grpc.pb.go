...
const (
	LoggerService_Log_FullMethodName = "/proto.LoggerService/Log"
)
...
type LoggerServiceClient interface {
	Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*SuccessResponse, error)
}
...
func (c *loggerServiceClient) Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*SuccessResponse, error) {
...
type LoggerServiceServer interface {
	Log(context.Context, *LogRequest) (*SuccessResponse, error)
...
func (UnimplementedLoggerServiceServer) Log(context.Context, *LogRequest) (*SuccessResponse, error) {
