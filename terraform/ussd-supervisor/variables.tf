...
variable "redis_test_host" {
  description = "Redis test host."
  type        = string
  default     = "127.0.0.1"
}

variable "redis_test_port" {
  description = "Redis test port."
  type        = number
  default     = 6379
}

variable "redis_test_password" {
  description = "Redis test password."
  type        = string
  default     = ""
  sensitive   = true
}

variable "redis_test_database" {
  description = "Redis test database."
  type        = number
  default     = 1
}
...
variable "postgres_test_host" {
  description = "Postgres test host."
  type        = string
  default     = "127.0.0.1"
}

variable "postgres_test_port" {
  description = "Postgres test port."
  type        = number
  default     = 5432
}
...
variable "momo_url" {
  description = "MOMO URL."
  type        = string
  default     = ""
}

variable "momo_key" {
  description = "MOMO key."
  type        = string
  default     = ""
  sensitive   = true
}
...
variable "airtel_url" {
  description = "Airtel URL."
  type        = string
  default     = ""
}

variable "airtel_id" {
  description = "Airtel ID."
  type        = string
  default     = ""
}

variable "airtel_key" {
  description = "Airtel key."
  type        = string
  default     = ""
  sensitive   = true
}

variable "sms_service_url" {
  description = "SMS service URL."
  type        = string
  default     = ""
}
